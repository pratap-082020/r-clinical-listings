...
title3 j=c "Table 16.1.2  Distribution of Maximum Liver Function Test Values by Treatment (safety population)";

options orientation=landscape;
ods escapechar='^';
ods rtf file ="E:\ROSHE30730\OUTPUTS\16_3_1.rtf" style=styles.test;
